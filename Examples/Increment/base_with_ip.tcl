...
CONFIG.CONST_WIDTH {8} \
  ...
  # Create instance: increment_0, and set properties
  set increment_0 [ create_bd_cell -type ip -vlnv test.com:hls:increment:1.0 increment_0 ]

  # Create instance: increment_1, and set properties
  set increment_1 [ create_bd_cell -type ip -vlnv test.com:hls:increment:1.0 increment_1 ]
...
CONFIG.C_IS_DUAL {1} \
  ...
  connect_bd_intf_net -intf_net iop1_M06_AXI [get_bd_intf_pins increment_1/s_axi_increment_1_io] [get_bd_intf_pins iop1/M06_AXI]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M13_AXI [get_bd_intf_pins increment_0/s_axi_increment_1_io] [get_bd_intf_pins processing_system7_0_axi_periph/M13_AXI]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C40000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs increment_0/s_axi_increment_1_io/Reg] SEG_increment_0_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A20000 [get_bd_addr_spaces iop1/mb/Data] [get_bd_addr_segs increment_1/s_axi_increment_1_io/Reg] SEG_increment_1_Reg
